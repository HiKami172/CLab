// Chernyak_lab4.2_v21.cpp : Ётот файл содержит функцию "main". «десь начинаетс€ и заканчиваетс€ выполнение программы.
...
//–≈јƒћ» 
//¬о-первых необходимо выставить кодировку на ANSI дл€ txt
//¬о-вторых лабу придумал гений, ибо буква € совпадает с EOF (очень смешно)
//» наконец, не выставл€й вижлу на дебаг, она с нашими буковами не пашет в дебаге, только релиз
...
const char* u_alp = "јЅ¬√ƒ≈®∆«»… ЋћЌќѕ–—“”‘’÷„ЎўЏџ№Ёёя";
const char* l_alp = "абвгдеЄжзийклмнопрстуфхцчшщъыбэю€";
